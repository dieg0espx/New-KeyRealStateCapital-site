...
import { FileText, User, Home, DollarSign, Clock, CheckCircle, AlertCircle, Loader2, ArrowLeft } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-white pt-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mb-8">
          <Link href="/">
            <Button variant="outline" className="border-transparent text-light-green hover:bg-light-green hover:text-white">
