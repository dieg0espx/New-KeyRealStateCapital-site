    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <Button
                size="sm"
                className="bg-[#02736D] hover:bg-[#025a54] text-white font-medium px-4 py-2 rounded-lg"
                onClick={openModal}
              >
      ...
      <section className="py-24 pt-32">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          {/* Top Sub-heading */}
          <p className="text-[#02736D] text-[22px] font-normal mb-8 leading-[30px]">
            For investors with $30k or more who want a complete done-for-you service
          </p>
          
          {/* Main Heading/Guarantee */}
          <h1 className="text-[32px] md:text-[36px] lg:text-[40px] font-medium text-black mb-16 leading-[44px] max-w-6xl mx-auto">
          ...
          {/* Attribution Text */}
          <p className="text-black text-[20px] font-normal mb-12 leading-[27px]">
          ...
          <Button
            onClick={openModal}
            size="lg"
            className="bg-[#02736D] hover:bg-[#025a54] text-white font-normal px-16 py-6 text-[20px] rounded-lg"
          >
            Book Free Investor Qualifying Call →
          </Button>
        </div>
      ...
      <section className="py-24 bg-[#F2F2F2]">
        <div className="w-full px-8 sm:px-12 lg:px-16 xl:px-20">
          <div className="text-center mb-16">
            <h2 className="text-[42px] font-medium text-black mb-6">
              Case Studies
            </h2>
          </div>

          <div className="relative w-full">
            <div ref={scrollContainerRef} className="overflow-x-auto mb-12 scrollbar-hide w-full" style={{ scrollBehavior: 'smooth' }}>
              <div className="flex gap-6 pb-4 px-4" style={{ width: 'max-content' }}>
              {/* Case Study 1 - person4 */}
              <div className="bg-white rounded-2xl p-8 shadow-lg flex-shrink-0 w-[360px]">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#02736D]">Lauren</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg flex-shrink-0 w-[360px]">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#02736D]">Carlos</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg flex-shrink-0 w-[360px]">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#02736D]">Jasmine</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg flex-shrink-0 w-[360px]">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#02736D]">Mark</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg flex-shrink-0 w-[360px]">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#02736D]">Sarah</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg flex-shrink-0 w-[360px]">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#02736D]">Michael</h3>
                    <p className="text-sm text-gray-600">August 3, 2024</p>
                  </div>
                </div>
                <p className="text-lg text-gray-900 leading-relaxed">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg flex-shrink-0 w-[360px]">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#02736D]">Jennifer</h3>
                    <p className="text-sm text-gray-600">September 12, 2024</p>
                  </div>
                </div>
                <p className="text-lg text-gray-900 leading-relaxed">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg flex-shrink-0 w-[360px]">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-[#02736D]">David</h3>
          ...
          <div className="text-center">
            <Button
              onClick={openModal}
              size="lg"
              className="bg-[#02736D] hover:bg-[#025a54] text-white font-normal px-16 py-6 text-2xl rounded-lg"
            >
              Book Free Investor Qualifying Call →
            </Button>
          </div>
      ...
      <section className="py-24 bg-gray-50/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-2xl font-medium text-[#02736D] mb-6">
              This Call is For You
            </h2>
            <h3 className="text-4xl md:text-5xl font-medium text-gray-900 mb-12 leading-tight">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6">
              <div className="bg-gray-100 rounded-2xl p-8">
                <p className="text-2xl font-normal text-gray-900 leading-relaxed">
            ...
            <div className="lg:order-2">
              <div className="rounded-2xl overflow-hidden h-[830px]">
                <img 
      ...
      <section className="py-24 bg-[#F2F2F2]">
        <div className="w-full px-8 sm:px-12 lg:px-16 xl:px-20">
          ...
          <div className="relative w-full">
            <div ref={testimonialsScrollRef} className="overflow-x-auto mb-12 scrollbar-hide w-full" style={{ scrollBehavior: 'smooth' }}>
              <div className="flex gap-6 pb-4 px-4" style={{ width: 'max-content' }}>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Right side - Content */}
            <div className="lg:order-2">
              <p className="text-[#02736D] text-lg font-normal mb-4">
      ...
      <section className="py-24 bg-[#F2F2F2]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="grid grid-cols-2 gap-6 w-[120%]">
              {/* Top-Left Card */}
              ...
              <div className="flex flex-col justify-center">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full px-6 py-4 bg-white rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#02736D]"
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    <Button
                      onClick={openModal}
                      size="lg"
                      className="bg-[#02736D] hover:bg-[#025a54] text-white font-normal px-16 py-4 text-xl w-full rounded-lg"
                    >
                      Book Free Investor Qualifying Call →
                    </Button>
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="text-center">
              ...
              <div className="flex justify-center">
                <Button 
                  onClick={openModal}
                  className="bg-light-green hover:bg-white text-white hover:text-perry font-light px-8 py-4 text-lg rounded-lg"
                >
                  Join Our Newsletter
                </Button>
              </div>
